...
print("🎨 Installing Subtle Xcode theme...")

let themeURL = URL(fileURLWithPath: #file.replacingOccurrences(of: "Sources/XcodeTheme/main.swift", with: "Subtle.xccolortheme"))
...
let themeFile = try themeFolder.createFile(named: "Subtle.xccolortheme")
try themeFile.write(themeData)

print("")
print("🎉 Subtle Xcode theme successfully installed")
